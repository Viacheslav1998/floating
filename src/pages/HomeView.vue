...
<template>
  ...
  <div class="bg-[url('../images/b2.jpg')] bg-cover p-5 bg-fixed">
    <div class="rounded-lg backdrop-blur-3xl bg-white/30 p-5 flex basis-1/2">
      <!-- posts max[4elems] -->
      <div class="grid grid-cols-2 gap-2 bg-white max-w-[800px]">
      ...
      <!-- and posts -->
      <!-- news-bnr-box -->     
      <div class="flex basis-1/4 bg-black">
        <div class="w-full rounded-lg h-[400px] bg-slate-400">
          <p>single news here ...</p>
        </div>  
      </div> 
      <!-- and news-bnr-box -->
